...
#ifndef BETTER_PLAYER_PLUS_SWIFT_H
#define BETTER_PLAYER_PLUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="better_player_plus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class FlutterError;
SWIFT_CLASS("_TtC18better_player_plus12BetterPlayer")
@interface BetterPlayer : NSObject <AVPictureInPictureControllerDelegate, FlutterPlatformView, FlutterStreamHandler>
...
SWIFT_CLASS("_TtC18better_player_plus37BetterPlayerEzDrmAssetsLoaderDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC18better_player_plus16BetterPlayerView")
...
SWIFT_CLASS("_TtC18better_player_plus12CacheManager")
...
@class AVAsset;
SWIFT_CLASS("_TtC18better_player_plus17CachingPlayerItem")
...
@protocol NSObject;
SWIFT_CLASS("_TtC18better_player_plus23SwiftBetterPlayerPlugin")
@interface SwiftBetterPlayerPlugin : NSObject <FlutterPlatformViewFactory, FlutterPlugin>
...
@interface SwiftBetterPlayerPlugin (SWIFT_EXTENSION(better_player_plus))
