...
#ifndef SHARE_HANDLER_IOS_SWIFT_H
#define SHARE_HANDLER_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="share_handler_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17share_handler_ios28SwiftShareHandlerIosPlatform")
@interface SwiftShareHandlerIosPlatform : NSObject <FlutterPlugin, FlutterStreamHandler>
